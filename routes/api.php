...
if(config("apiauth.routes.allowed") == true){
    Route::group(['prefix' => config('apiauth.routes.routes_prefix') ?? "api", 'middleware' =>config('apiauth.routes.routes_middlewares') ?? ["api"]], function() {
